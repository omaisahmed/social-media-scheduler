...
<x-slot name="header">
    <x-core::page-header title="Edit template" description="{{ $template->name }}" />
</x-slot>
...
<form method="POST" action="{{ route('templates.update', $template) }}" class="space-y-6">
    ...
    <div class="grid gap-6 lg:grid-cols-3">
        <div class="lg:col-span-2">
            <x-core::card title="Template details" description="Update this reusable template.">
                <div class="space-y-5">
                    <div>
                        <x-input-label for="name" value="Name" required />
                        <x-text-input id="name" name="name" class="mt-1.5" :value="old('name', $template->name)" required autofocus />
            ...
            <x-core::card title="Organization" description="Categorize your template with tags."
                ...
                <div>
                    ...
                    <div class="relative mt-1.5">
                        ...
                        <x-text-input id="tags" name="tags" class="pl-9" :value="old('tags', implode(', ', $template->tags ?? []))" placeholder="promo, launch, blog" />
                    </div>
